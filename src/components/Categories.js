...
const Categories = () => {
  ...
  return (
    <div className='max-w-5xl mx-auto pt-6'>
      <p className='text-center font-normal text-2xl'>Trouvez votre bien immobilier au Maroc</p>
      <div className="flex flex-wrap justify-center text-center gap-6 py-10">
